...
/// Defines how conventional commit types map to semantic version increments.
///
/// This configuration controls which [VersionIncrement] is applied for each
/// commit type when calculating the next package version.
final class VersioningConfig {
  ...
  static const defaultConfig = VersioningConfig._(
    incrementByCommitType: {
      'feat': VersionIncrement.minor,
      'fix': VersionIncrement.patch,
      'perf': VersionIncrement.minor,
